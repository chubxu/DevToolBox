/**
 * from https://www.npmjs.com/package/xml-js
 */
...
function validateOptions(userOptions) {
  var options = copyOptions(userOptions);
  ...
  ensureFlagExists('indentText', options);
  ensureFlagExists('indentCdata', options);
  ensureFlagExists('indentAttributes', options);
  ensureFlagExists('indentInstruction', options);
  ensureFlagExists('fullTagEmptyElement', options);
  ensureFlagExists('noQuotesForNativeAttributes', options);
  ...
  checkFnExists('fullTagEmptyElement', options);
  return options;
}
